...
@Component({
  selector: 'app-flower-seeds-details',
  templateUrl: './flower-seeds-details.component.html',
  styleUrls: ['./flower-seeds-details.component.css']
})
export class FlowerSeedsDetailsComponent implements OnInit {

  constructor(private route:ActivatedRoute,private cartsrv:CartService) { }

  currentRate= 3
  flowerseedDetails:any=(product as any).default;
  course:any;
  totalid:number | any;
  ...
  ngOnInit(): void {
    ...
    this.course=this.flowerseedDetails.find((x:any) => x.pid==this.totalid);
