...
import * as indoorprod from "src/app/plantdata/indoorplants.json";

@Component({
  selector: 'app-indoorplantsdetails',
  templateUrl: './indoorplantsdetails.component.html',
  styleUrls: ['./indoorplantsdetails.component.css']
})
export class IndoorplantsdetailsComponent implements OnInit {

  constructor(private route:ActivatedRoute,private cartsrv:CartService) { }

  currentRate= 3
  indoorplantsDetails:any=(indoorprod as any).default;
  course:any;
  totalid:number | any;
  ...
  ngOnInit(): void {
    ...
    this.course=this.indoorplantsDetails.find((x:any) => x.pid==this.totalid);
