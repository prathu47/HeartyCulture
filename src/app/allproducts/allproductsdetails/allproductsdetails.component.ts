...
import * as allproduct from "src/app/allproducts/allproducts.json";

@Component({
  selector: 'app-allproductsdetails',
  templateUrl: './allproductsdetails.component.html',
  styleUrls: ['./allproductsdetails.component.css']
})
export class AllproductsdetailsComponent implements OnInit {

  constructor(private route:ActivatedRoute,private cartsrv:CartService) { }

  currentRate= 3
  allprodDetails:any=(allproduct as any).default;
  course:any;
  totalid:number | any;
  ...
  ngOnInit(): void {
    ...
    this.course=this.allprodDetails.find((x:any) => x.pid==this.totalid);
